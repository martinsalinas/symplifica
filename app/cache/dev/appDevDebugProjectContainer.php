...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '107.180.51.83', 'port' => NULL, 'dbname' => 'symplifica', 'user' => 'Martin22', 'password' => 'Martin22', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array('enum' => 'string'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/SymplificaBundle/Entity'))), 'SymplificaBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('SymplificaBundle' => 'SymplificaBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_726296ea38442743247dca5a3b0c52c03674cda1728b9db8a26b5e55c0518c29');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SymplificaBundle/Resources/views'), 'Symplifica');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c7b51edbf716f3c62be7520827961715ccbed320');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('592dd033c901c0.92732785')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SymplificaBundle' => 'SymplificaBundle\\SymplificaBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'SymplificaBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/SymplificaBundle'),
            ...
            'database_host' => '107.180.51.83',
            'database_port' => NULL,
            'database_name' => 'symplifica',
            'database_user' => 'Martin22',
            'database_password' => 'Martin22',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'c7b51edbf716f3c62be7520827961715ccbed320',
            'locale' => 'en',
            ...
            'kernel.secret' => 'c7b51edbf716f3c62be7520827961715ccbed320',
